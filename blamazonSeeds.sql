...
VALUES
    ('Apparel', 'Dress Shirt', 'Blue, 100% cotton long sleeve shirt, size M', 19.95, 50, 7.65, 5),
    ...
    ('Books', 'Harry Potter', 'Harry Potter and the Lump of Clay, by J.K. Rowling', 25.75, 20, 12.29, 0),
    ('Books', 'What Do People Do All Day?', 'What Do People Do All Day?, by Richard Scarry', 14.95, 15, 6.75, 2),
